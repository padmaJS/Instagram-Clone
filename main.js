function load() {
    ...
    for (var i = 0; i < likeButtons.length; i++){
    	likeButtons[i].addEventListener("click", function(e){
    		e.onclick = () => {
    			likeButtons[i].removeChild(likeButtons[i]);
